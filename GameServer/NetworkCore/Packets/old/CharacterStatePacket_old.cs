...
namespace NetworkCore.Packets.old
{
    ...
    public class CharacterStatePacket_old : PacketBase
    {
        ...
        *//*public void Init(int id, string name, int health, int mana, float posX, float posY, float posZ, float rot)
        ...
        public CharacterStatePacket_old(int playerVId) : base(typeof(CharacterStatePacket_old))
        {
            Write("CharacterVId", playerVId);
        }

        public CharacterStatePacket_old(Character player) : base(typeof(CharacterStatePacket_old))
        {
        ...
        public CharacterStatePacket_old(PacketBase packet) : base(packet) { }

        public CharacterStatePacket_old(byte[] data) : base(data) { }
