...
namespace Assets.Code.Scripts.NetClient.Emissary
{
    public class AdventurerTransformEmissary : MonoBehaviour
    {
        ...
        {
            TransformData Transform = AdventurerChrTransformCollection.Find(transform => transform.CharacterVId == TransformPacket.CharacterVId);
            if (Transform != null)
            {
        ...
        public void AddAdventurerTransform(TransformData transformData)
        {
            ...
            if (!AdventurerChrTransformCollection.Any(transform => transform.CharacterVId == transformData.CharacterVId))
