    ...
    public class VisibleCharactersCollection
    {
        ...
        public void OnCharacterStateUpdateReceived(CharacterStateUpdatePacket statePacket)
        {
            ...
            if (VisiblePlayers.TryGetValue(charVId, out Character foundedCharacter))
            {
                ...
                foundedCharacter.CurrentHealth = statePacket.CurrentHealth ?? foundedCharacter.CurrentHealth;
                foundedCharacter.MaxHealth = statePacket.MaxHealth ?? foundedCharacter.MaxHealth;
                foundedCharacter.CurrentMana = statePacket.CurrentMana ?? foundedCharacter.CurrentMana;
                foundedCharacter.MaxMana = statePacket.MaxMana ?? foundedCharacter.MaxMana;
